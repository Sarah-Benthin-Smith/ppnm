...
'ann_opgB.data' using 1:4 axes x1y2 with lines lw 3 lc rgb '#d721c2' title 'first derivative (ann)', \
'ann_opgB.data' using 1:5 axes x1y2 with lines lw 3 lc rgb '#c80c0c' title 'second derivative (ann)', \
